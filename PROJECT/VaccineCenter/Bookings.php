...
<head>
  ...
  <style>
    ...
    table {
      width: 90%;
      margin: 30px auto; /* Adding some margin at the top and bottom */
    ...
    .status-pending {
      color: #388e3c; /* Orange for pending */
      font-weight: bold;
    }

    .status-completed {
      color: #f57c00; /* Green for completed */
      font-weight: bold;
    }
  ...
  <table>
    ...
    while ($data = $row->fetch_assoc()) {
      ...
      <tr>
        ...
        <td class="slot-time"><?php echo $data['slot_from'] ?> - <?php echo $data['slot_to'] ?></td>
