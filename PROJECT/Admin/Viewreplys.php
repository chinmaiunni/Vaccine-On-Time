...
if(isset($_GET["delID"]))
{
    ...
    if($con->query($delQry))
	{
                ...
                <script>
				alert('Deleted');
				window.location="Viewreplys.php";
				</script>
                <?php
	}
}
...
<head>
  ...
  <title>View User Complaints with Replies</title>
  <style>
    * {
      margin: 0;
      padding: 0;
        ...
        <tbody>
          ...
          while ($data = $row->fetch_assoc()) {
              ...
              <tr>
                ...
                <td><a href="Viewreplys.php?delID=<?php echo $data['complaint_id'] ?>">Delete</a></td>
              </tr>
              <?php
          }
          ?>
